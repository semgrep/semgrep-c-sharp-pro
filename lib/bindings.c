/*
  Generated by ocaml-tree-sitter for c_sharp_pro.
*/
...
TSLanguage *tree_sitter_c_sharp_pro();
...
// OCaml function
CAMLprim value octs_create_parser_c_sharp_pro(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  ts_parser_set_language(parser, tree_sitter_c_sharp_pro());
  CAMLreturn(v);
};

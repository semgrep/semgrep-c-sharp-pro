...
(**
    Functions for parsing c_sharp_pro programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a c_sharp_pro program from a string into a typed OCaml CST.
...
(** Parse a c_sharp_pro program from a file into a typed OCaml CST.
